...
void help() {
    ...
    const char* text[] = {
        ...
        "gets created when the add-in starts.",
        "",
        ...
        "entering a name you can see the",
        "return code and the meaning of it.",
        ...
        "delete some directories to allow",
        ...
        "the flags. You can delete the",
        "currently selected entry by",
        "pressing [EXE].",
        "The following return codes are",
        "possible:",
        "- 0: Success",
