...
void help() {
    ...
    const char* text[] = {
        ...
        "of all directories. [Êê] and [Êë] go",
        "one entry left or right. [Êí] and [Êì]",
        ...
        "directory you can view them with",
        "[F1]. The name, length in Bytes and",
        "the flags of each item are shown.",
